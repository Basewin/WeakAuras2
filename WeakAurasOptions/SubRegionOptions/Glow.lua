...
local function createOptions(parentData, data, index, subIndex)
  ...
  local options = {
    ...
    glowExtraDescription = {
      ...
      name = function()
        ...
        if data.useGlowColor then
          color =
            L["|c%02x%02x%02x%02xColor|r"]:format(
        ...
        elseif data.glowType == "ACShine" then
          line =
            L["%s %s, Particles: %d, Frequency: %0.2f, Scale: %0.2f"]:format(
              line,
              color,
              data.glowLines,
              data.glowFrequency,
        ...
        elseif data.glowType == "Pixel" then
          line =
            L["%s %s, Lines: %d, Frequency: %0.2f, Length: %d, Thickness: %d"]:format(
              line,
              color,
              data.glowLines,
              data.glowFrequency,
    ...
    glowExpand = {
      ...
      name = function()
        local collapsed =
          WeakAuras.IsCollapsed("glow", "glow", "glowextra" .. index, true)
