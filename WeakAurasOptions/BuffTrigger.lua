...
local actual_unit_types_with_specific =
      ...
      func = function()
        if data.controlledChildren then
          for index, childId in pairs(data.controlledChildren) do
            ...
            local trigger =
              childData.triggers[optionTriggerChoices[childId]] and childData.triggers[optionTriggerChoices[childId]].trigger
            if trigger then
...
local function GetBuffTriggerOptions(data, optionTriggerChoices)
  ...
  local aura_options = {
    ...
    name1 = {
      ...
      get = function(info)
        return trigger.spellIds[1] and tostring(
          trigger.spellIds[1]
        ) or trigger.names[1]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[1], trigger.spellIds[1] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name2 = {
      ...
      get = function(info)
        return trigger.spellIds[2] and tostring(
          trigger.spellIds[2]
        ) or trigger.names[2]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[2], trigger.spellIds[2] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name3 = {
      ...
      get = function(info)
        return trigger.spellIds[3] and tostring(
          trigger.spellIds[3]
        ) or trigger.names[3]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[3], trigger.spellIds[3] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name4 = {
      ...
      get = function(info)
        return trigger.spellIds[4] and tostring(
          trigger.spellIds[4]
        ) or trigger.names[4]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[4], trigger.spellIds[4] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name5 = {
      ...
      get = function(info)
        return trigger.spellIds[5] and tostring(
          trigger.spellIds[5]
        ) or trigger.names[5]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[5], trigger.spellIds[5] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name6 = {
      ...
      get = function(info)
        return trigger.spellIds[6] and tostring(
          trigger.spellIds[6]
        ) or trigger.names[6]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[6], trigger.spellIds[6] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name7 = {
      ...
      get = function(info)
        return trigger.spellIds[7] and tostring(
          trigger.spellIds[7]
        ) or trigger.names[7]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[7], trigger.spellIds[7] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name8 = {
      ...
      get = function(info)
        return trigger.spellIds[8] and tostring(
          trigger.spellIds[8]
        ) or trigger.names[8]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[8], trigger.spellIds[8] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    name9 = {
      ...
      get = function(info)
        return trigger.spellIds[9] and tostring(
          trigger.spellIds[9]
        ) or trigger.names[9]
      end,
      set = function(info, v)
        if (v == "") then
          ...
          trigger.names[9], trigger.spellIds[9] =
            WeakAuras.spellCache.CorrectAuraName(v)
        end
        WeakAuras.Add(data)
        WeakAuras.UpdateThumbnail(data)
    ...
    group_count = {
      ...
      desc = function()
        local groupType =
          unit_types[trigger.unit or "group"] or "|cFFFF0000error|r"
    ...
    name_info = {
      ...
      disabled = function()
        return not WeakAuras.CanShowNameInfo(data)
      end,
      get = function()
    ...
    stack_info = {
      ...
      disabled = function()
        return not WeakAuras.CanShowStackInfo(data)
      end,
      get = function()
