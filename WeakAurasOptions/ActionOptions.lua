...
function WeakAuras.AddActionOption(id, data)
  local action = {
    ...
    get = function(info)
      ...
      if split then
        local field, value =
          info[#info]:sub(1, split - 1),
          info[#info]:sub(split + 1)
    ...
    set = function(info, v, g, b, a)
      ...
      if (info.type == "color") then
        if not data.actions[field][value] or type(
    ...
    args = {
      ...
      start_message_space = {
        ...
        hidden = function()
          return not (data.actions.start.message_type == "WHISPER" or data.actions.start.message_type == "CHANNEL" or data.actions.start.message_type == "COMBAT" or data.actions.start.message_type == "PRINT")
        end
      },
      start_message_color = {
        type = "color",
        ...
        hasAlpha = false,
        hidden = function()
          return not (data.actions.start.message_type == "COMBAT" or data.actions.start.message_type == "PRINT")
        end,
        get = function()
      ...
      start_message_channel = {
        ...
        hidden = function()
          return data.actions.start.message_type ~= "CHANNEL"
        end
      },
      start_message = {
        type = "input",
      ...
      start_choose_glow_frame = {
        ...
        func = function()
          if (data.controlledChildren and data.controlledChildren[1]) then
            ...
            WeakAuras.StartFrameChooser(
              WeakAuras.GetData(data.controlledChildren[1]),
              { "actions", "start", "glow_frame" }
            )
          else
            WeakAuras.StartFrameChooser(
              data,
      ...
      finish_message_space = {
        ...
        hidden = function()
          return not (data.actions.finish.message_type == "WHISPER" or data.actions.finish.message_type == "CHANNEL")
        end
      },
      finish_message_color = {
        ...
        hasAlpha = false,
        hidden = function()
          return not (data.actions.finish.message_type == "COMBAT" or data.actions.finish.message_type == "PRINT")
        end,
        get = function()
      ...
      finish_message_channel = {
        ...
        hidden = function()
          return data.actions.finish.message_type ~= "CHANNEL"
        end
      },
      finish_message = {
        type = "input",
  ...
  WeakAuras.AddCodeOption(
    ...
    L["Custom Code"],
    "init",
    "https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Actions",
    0.011,
    function()
  ...
  WeakAuras.AddCodeOption(
    ...
    5.1,
    function()
      return not (data.actions.start.do_message and WeakAuras.ContainsCustomPlaceHolder(
        data.actions.start.message
      ))
    end,
  ...
  WeakAuras.AddCodeOption(
    ...
    26,
    function()
      return not (data.actions.finish.do_message and WeakAuras.ContainsCustomPlaceHolder(
        data.actions.finish.message
      ))
    end,
