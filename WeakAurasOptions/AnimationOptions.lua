      ...
      if preset then
        if (regionType == "group" or regionType == "dynamicgroup") then
          ...
          for index, childId in pairs(data.controlledChildren) do
            local childRegion =
              WeakAuras.regions[childId] and WeakAuras.regions[childId].region
...
function WeakAuras.AddAnimationOption(id, data)
  local animation = {
    ...
    args = {
      ...
      start_duration_type_no_choice = {
        ...
        disabled = true,
        hidden = function()
          return data.animation.start.type ~= "custom" or WeakAuras.CanHaveDuration(
            data
          )
        end,
        get = function()
      ...
      start_duration_type = {
        ...
        hidden = function()
          return data.animation.start.type ~= "custom" or not WeakAuras.CanHaveDuration(
            data
          )
        end
      },
      ...
      main_duration_type_no_choice = {
        ...
        disabled = true,
        hidden = function()
          return data.animation.main.type ~= "custom" or WeakAuras.CanHaveDuration(
            data
          )
        end,
        get = function()
      ...
      main_duration_type = {
        ...
        values = duration_types,
        hidden = function()
          return data.animation.main.type ~= "custom" or not WeakAuras.CanHaveDuration(
            data
          )
        end
      },
      main_duration = {
        ...
        desc = function()
          if (data.animation.main.duration_type == "relative") then
            ...
            ret =
              ret .. L["Unlike the start or finish animations, the main animation will loop over and over until the display is hidden."]
            return ret
          end
        end,
        order = 53.5,
  ...
  WeakAuras.AddCodeOption(
    ...
    L["Custom Function"],
    "start_alphaFunc",
    "https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Animation-Functions",
    35.3,
    hideStartAlphaFunc,
