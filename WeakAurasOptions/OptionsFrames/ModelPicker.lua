...
local function ConstructModelPicker(frame)
  ...
  group.frame:SetScript("OnUpdate", function()
    ...
    modelPickerTX.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      15 + narrowSliderWidth,
      43
    )

    modelPickerTY.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      20 + narrowSliderWidth,
      43
    )
    modelPickerTY.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      20 + (2 * narrowSliderWidth),
      43
    )

    modelPickerTZ.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      25 + (2 * narrowSliderWidth),
      43
    )
    modelPickerTZ.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      25 + (3 * narrowSliderWidth),
      43
    )

    modelPickerRX.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      30 + (3 * narrowSliderWidth),
      43
    )
    modelPickerRX.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      30 + (4 * narrowSliderWidth),
      43
    )

    modelPickerRY.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      35 + (4 * narrowSliderWidth),
      43
    )
    modelPickerRY.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      35 + (5 * narrowSliderWidth),
      43
    )

    modelPickerRZ.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      40 + (5 * narrowSliderWidth),
      43
    )
    modelPickerRZ.frame:SetPoint(
      "bottomright",
      frame,
      "bottomleft",
      40 + (6 * narrowSliderWidth),
      43
    )

    modelPickerUS.frame:SetPoint(
      "bottomleft",
      frame,
      "bottomleft",
      45 + (6 * narrowSliderWidth),
      43
    )
    modelPickerUS.frame:SetPoint(
      "bottomright",
